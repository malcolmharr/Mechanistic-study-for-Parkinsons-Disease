...
set reference [atomselect top "chain H and resid 98 to 105" frame 0]

set compare [atomselect top "chain H and resid 98 to 105"]

set num_steps [molinfo top get numframes]

set outfile [open hcdr3rmsd3.csv w]
